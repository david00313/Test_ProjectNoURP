...
public class QuickslotInventory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < quickslotParent.childCount; i++)
        {
            ...
            if (Input.GetKeyDown((i + 1).ToString()))
            {
                ...
                {
                    Debug.Log("Curent quick slot" + currentQuickslotID);
    ...
    private void ChangeCharacteristics()
    {
        ...
        if (Indicators.healthAmount + quickslotParent.GetChild(currentQuickslotID).GetComponent<InventorySlot>().item.changeHealth <= 100)
        {
            float newHealth = Indicators.healthAmount + quickslotParent.GetChild(currentQuickslotID).GetComponent<InventorySlot>().item.changeHealth;
            Indicators.healthAmount = newHealth;
        }
